      ...
      try {
        if (isSuperAdmin) {
          ...
          const [logs, accreditations] = await Promise.all([
            ...
            AccreditationsAPI.getDashboardDistribution(targetEventId)
          ]);
          ...
          const [logs, accreditations] = await Promise.all([
            ...
            AccreditationsAPI.getDashboardDistribution(user.allowedEventIds[0])
          ]);
          setLiveScanLogs(logs || []);
          setEventAccreditations(accreditations || []);
        }
                  ...
                  <div className="w-full bg-base rounded-full h-[6px] overflow-hidden border border-white/5 relative z-10 mt-1.5">
                    <motion.div
                      ...
                      className={cn(
                        ...
                        perc > 90
                          ? "bg-gradient-to-r from-rose-500 to-rose-400 shadow-[0_0_12px_rgba(244,63,94,0.4)]"
                          : perc > 75
                        ...
                        <div className="h-[6px] w-full bg-base-alt rounded-full overflow-hidden border border-white/5 shadow-inner">
                          <motion.div
                            ...
                            className={cn(
                              "h-full rounded-full",
                              cappedRatio > 90
                                ? "shadow-[0_0_10px_rgba(244,63,94,0.3)] bg-gradient-to-r from-rose-600 to-rose-400"
                                : cappedRatio > 75
                                  ? "shadow-[0_0_10px_rgba(245,158,11,0.3)] bg-gradient-to-r from-amber-600 to-amber-400"
                                  : "shadow-[0_0_10px_rgba(16,185,129,0.3)] bg-gradient-to-r from-emerald-600 to-emerald-400"
                            )}
                          />
                        </div>
                      </div>
