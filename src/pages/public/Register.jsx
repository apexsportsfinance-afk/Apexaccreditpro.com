...
import EventScheduleDropdown from "./register/EventScheduleDropdown";
...
export default function Register() {
  ...
  const validateForm = () => {
    ...
    const isRequiredAndVisible = (fieldId) => {
      const isVisible = fieldConfig?.[fieldId]?.show !== false;
      const isReq = fieldConfig?.[fieldId]?.required !== false;
      return isVisible && isReq;
    };

    if (isRequiredAndVisible('firstName') && !formData.firstName.trim()) newErrors.firstName = "First name is required";
    if (isRequiredAndVisible('lastName') && !formData.lastName.trim()) newErrors.lastName = "Last name is required";
    if (isRequiredAndVisible('gender') && !formData.gender) newErrors.gender = "Gender is required";
    if (isRequiredAndVisible('dateOfBirth') && !formData.dateOfBirth) newErrors.dateOfBirth = "Date of birth is required";
    if (isRequiredAndVisible('nationality') && !formData.nationality) newErrors.nationality = "Nationality is required";
    ...
    if (visibilityConfig.affiliation !== false && fieldConfig?.['affiliation_info']?.show !== false) {
      ...
      if (isRequiredAndVisible('participatingSports') && (isTeamRole || hasCategorySports) && event?.sportList && event.sportList.length > 0 && (!formData.selectedSports || formData.selectedSports.length === 0)) {
            ...
            {fieldConfig?.['personalInfo']?.show !== false && (
              <div className="space-y-4 relative z-[100]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {fieldConfig?.['firstName']?.show !== false && (
                    <Input
                      label={t("firstName")}
                      name="firstName"
                  ...
                  {fieldConfig?.['lastName']?.show !== false && (
                    <Input
                      label={t("lastName")}
                      name="lastName"
                  ...
                  {fieldConfig?.['dateOfBirth']?.show !== false && (
                    <Input
                      label={t("dateOfBirth")}
                      name="dateOfBirth"
                      type="date"
                ...
                {fieldConfig?.['nationality']?.show !== false && (
              ...
              {visibilityConfig.affiliation !== false && fieldConfig?.['affiliation_info']?.show !== false && (
              ...
              {fieldConfig?.['organization']?.show !== false && (
              ...
              {fieldConfig?.['participatingSports']?.show !== false && (() => {
                const isTeamRole = formData.role && (teamRoles.includes(formData.role.toLowerCase()) || formData.role.toLowerCase().includes("athlete") || formData.role.toLowerCase().includes("coach"));
