...
import { Volume2, Upload, Trash } from "lucide-react";
import { supabase } from "../lib/supabase";
import { audioService } from "../lib/audio";
import { cn } from "../lib/utils";

export const defaultMessages = {
  firstScan: { text: "Access Granted", voice: "Welcome [FullName]", audioUrl: null },
  secondScan: { text: "Already Attended", voice: "Already Attended", audioUrl: null },
  accessDenied: { text: "Access Denied", voice: "Access Denied", audioUrl: null },
  invalidQr: { text: "Invalid QR", voice: "Invalid QR", audioUrl: null },
  wrongZone: { text: "Wrong Zone", voice: "Wrong Zone", audioUrl: null },
  expired: { text: "Expired Accreditation", voice: "Expired", audioUrl: null }
};
