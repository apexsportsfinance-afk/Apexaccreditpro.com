        ...
        <div style={{ height: "40px", width: "100%", overflow: "hidden", boxShadow: "0 4px 6px -1px rgba(0, 0, 0, 0.1)", flexShrink: 0 }}>
          {roleBannerUrl ? (
            ...
            <div style={{ 
              ...
              color: categoryStyle.textColor || "#000000", 
              fontSize: categoryStyle.fontSize || "14px", 
              fontWeight: categoryStyle.fontWeight || "bold", 
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "6px", marginTop: "6px", fontSize: `${CARD_FONT_SIZE}px`, color: "#475569", ...cardFont, flexWrap: "wrap" }}>
              ...
              {accreditation?.gender && (
                <>
                  ...
                  <span style={{ fontWeight: 500 }}>{accreditation.gender}</span>
                </>
              )}
              {isAthlete && age !== null && (
                <>
            ...
            {(() => {
              ...
              return (
                <div style={{ marginTop: "12px", display: "flex", alignItems: "center", gap: "12px" }}>
                  ...
                  {countryNameUrl ? (
                    <img src={countryNameUrl} alt={countryName} style={{ height: `${nameSize + 4}px`, maxWidth: "120px", objectPosition: "left" }} />
                  ) : (
