 ...
 * Renders cards into a fresh offscreen div on document.body
 * Completely outside any modal, scroll, or overflow clipping.
 */
...
/* ═══════════════════════════════════════════════════
   Inline all <img> src in a container as base64
   ═══════════════════════════════════════════════════ */
const inlineAllImages = async (container) => {
  ...
  /* Wait for all to report complete */
  await Promise.all(
    imgs.map(
      (img) =>
        new Promise((res) => {
...
/* ═══════════════════════════════════════════════════
   Render CardInner offscreen on document.body
   Returns { frontEl, backEl, cleanup }
   ═══════════════════════════════════════════════════ */
...
/* ═══════════════════════════════════════════════════
   Capture both cards as data URLs (for images/print)
   ═══════════════════════════════════════════════════ */
...
/**
 * NOTE: These functions now take (accreditation, event, zones, ...)
 * instead of (frontId, backId, ...) because we render offscreen.
 * Update BadgeGenerator.jsx accordingly (see below).
 */
