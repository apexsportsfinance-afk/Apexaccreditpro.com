...
export const AttendanceAPI = {
  ...
  recordScan: async ({ eventId, athleteId, clubName, scannerLocation, date, sessionId, zoneOnly }) => {
    try {
      ...
      // Check if duplicate exists for this specific session/gate
      let query = supabase
      ...
      // ALWAYS filter by location to keep counts isolated per gate/zone
      const locationKey = scannerLocation || "Main Entrance";
      query = query.eq("scanner_location", locationKey);
